...
export { GRADE_EXCELLENT, GRADE_FAILING, lastInspectionOf } from './boards.js'
export { holdsCommand, letterFor, subordinatesOf, superiorOf, tediumOf } from './garrison.js'
export { DUTY_TITLES, enlistedBy, recruiterNow, specialDutyOf } from './specialduty.js'
export { aftermathOf, attributionFor, LASTING_AT, warBondWith } from './aftermath.js'
export type { Aftermath, Attribution, Bond } from './aftermath.js'
export type { SpecialDuty } from './specialduty.js'
