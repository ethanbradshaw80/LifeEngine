...
(ADR-0030), enlistment (ADR-0031 to ADR-0033), and the fixes and the
...
SIMULATION_VERSION 193, 1736 tests green across 151 files. Shipped to itch.io
as v187, the Military Depth update.
